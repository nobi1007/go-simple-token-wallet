...
func (_Token *TokenCaller) BalanceOfAt(opts *bind.CallOpts, account common.Address, snapshotId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "balanceOfAt", account, snapshotId)
...
//
// Solidity: function balanceOfAt(address account, uint256 snapshotId) view returns(uint256)
func (_Token *TokenSession) BalanceOfAt(account common.Address, snapshotId *big.Int) (*big.Int, error) {
	return _Token.Contract.BalanceOfAt(&_Token.CallOpts, account, snapshotId)
}

// BalanceOfAt is a free data retrieval call binding the contract method 0x4ee2cd7e.
//
// Solidity: function balanceOfAt(address account, uint256 snapshotId) view returns(uint256)
func (_Token *TokenCallerSession) BalanceOfAt(account common.Address, snapshotId *big.Int) (*big.Int, error) {
	return _Token.Contract.BalanceOfAt(&_Token.CallOpts, account, snapshotId)
}
...
func (_Token *TokenCaller) MintableGroup(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "mintableGroup", arg0)
...
//
// Solidity: function mintableGroup(address ) view returns(bool)
func (_Token *TokenSession) MintableGroup(arg0 common.Address) (bool, error) {
	return _Token.Contract.MintableGroup(&_Token.CallOpts, arg0)
}

// MintableGroup is a free data retrieval call binding the contract method 0xec49c938.
//
// Solidity: function mintableGroup(address ) view returns(bool)
func (_Token *TokenCallerSession) MintableGroup(arg0 common.Address) (bool, error) {
	return _Token.Contract.MintableGroup(&_Token.CallOpts, arg0)
}
...
func (_Token *TokenCaller) TotalSupplyAt(opts *bind.CallOpts, snapshotId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "totalSupplyAt", snapshotId)
...
//
// Solidity: function totalSupplyAt(uint256 snapshotId) view returns(uint256)
func (_Token *TokenSession) TotalSupplyAt(snapshotId *big.Int) (*big.Int, error) {
	return _Token.Contract.TotalSupplyAt(&_Token.CallOpts, snapshotId)
}

// TotalSupplyAt is a free data retrieval call binding the contract method 0x981b24d0.
//
// Solidity: function totalSupplyAt(uint256 snapshotId) view returns(uint256)
func (_Token *TokenCallerSession) TotalSupplyAt(snapshotId *big.Int) (*big.Int, error) {
	return _Token.Contract.TotalSupplyAt(&_Token.CallOpts, snapshotId)
}
...
func (_Token *TokenTransactor) BatchTransfer(opts *bind.TransactOpts, recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "batchTransfer", recipients, amounts)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x88d695b2.
//
// Solidity: function batchTransfer(address[] recipients, uint256[] amounts) returns()
func (_Token *TokenSession) BatchTransfer(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Token.Contract.BatchTransfer(&_Token.TransactOpts, recipients, amounts)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x88d695b2.
//
// Solidity: function batchTransfer(address[] recipients, uint256[] amounts) returns()
func (_Token *TokenTransactorSession) BatchTransfer(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _Token.Contract.BatchTransfer(&_Token.TransactOpts, recipients, amounts)
}
...
func (_Token *TokenTransactor) SetMintable(opts *bind.TransactOpts, account common.Address, allow bool) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setMintable", account, allow)
}

// SetMintable is a paid mutator transaction binding the contract method 0xf7eb06c4.
//
// Solidity: function setMintable(address account, bool allow) returns()
func (_Token *TokenSession) SetMintable(account common.Address, allow bool) (*types.Transaction, error) {
	return _Token.Contract.SetMintable(&_Token.TransactOpts, account, allow)
}

// SetMintable is a paid mutator transaction binding the contract method 0xf7eb06c4.
//
// Solidity: function setMintable(address account, bool allow) returns()
func (_Token *TokenTransactorSession) SetMintable(account common.Address, allow bool) (*types.Transaction, error) {
	return _Token.Contract.SetMintable(&_Token.TransactOpts, account, allow)
}
...
func (_Token *TokenTransactor) Snapshot(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "snapshot")
}

// Snapshot is a paid mutator transaction binding the contract method 0x9711715a.
//
// Solidity: function snapshot() returns()
func (_Token *TokenSession) Snapshot() (*types.Transaction, error) {
	return _Token.Contract.Snapshot(&_Token.TransactOpts)
}

// Snapshot is a paid mutator transaction binding the contract method 0x9711715a.
//
// Solidity: function snapshot() returns()
func (_Token *TokenTransactorSession) Snapshot() (*types.Transaction, error) {
	return _Token.Contract.Snapshot(&_Token.TransactOpts)
}
...
// TokenMintableIterator is returned from FilterMintable and is used to iterate over the raw logs and unpacked data for Mintable events raised by the Token contract.
type TokenMintableIterator struct {
	Event *TokenMintable // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenMintableIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenMintableIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenMintableIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenMintable represents a Mintable event raised by the Token contract.
type TokenMintable struct {
...
func (_Token *TokenFilterer) FilterMintable(opts *bind.FilterOpts) (*TokenMintableIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "Mintable")
	if err != nil {
		return nil, err
	}
	return &TokenMintableIterator{contract: _Token.contract, event: "Mintable", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Mintable(address account)
func (_Token *TokenFilterer) WatchMintable(opts *bind.WatchOpts, sink chan<- *TokenMintable) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "Mintable")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenMintable)
				if err := _Token.contract.UnpackLog(event, "Mintable", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Mintable(address account)
func (_Token *TokenFilterer) ParseMintable(log types.Log) (*TokenMintable, error) {
	event := new(TokenMintable)
	if err := _Token.contract.UnpackLog(event, "Mintable", log); err != nil {
		return nil, err
	}
...
// TokenSnapshotIterator is returned from FilterSnapshot and is used to iterate over the raw logs and unpacked data for Snapshot events raised by the Token contract.
type TokenSnapshotIterator struct {
	Event *TokenSnapshot // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenSnapshotIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenSnapshotIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenSnapshotIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenSnapshot represents a Snapshot event raised by the Token contract.
...
func (_Token *TokenFilterer) FilterSnapshot(opts *bind.FilterOpts) (*TokenSnapshotIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "Snapshot")
	if err != nil {
		return nil, err
	}
	return &TokenSnapshotIterator{contract: _Token.contract, event: "Snapshot", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Snapshot(uint256 id)
func (_Token *TokenFilterer) WatchSnapshot(opts *bind.WatchOpts, sink chan<- *TokenSnapshot) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "Snapshot")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenSnapshot)
				if err := _Token.contract.UnpackLog(event, "Snapshot", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Snapshot(uint256 id)
func (_Token *TokenFilterer) ParseSnapshot(log types.Log) (*TokenSnapshot, error) {
	event := new(TokenSnapshot)
	if err := _Token.contract.UnpackLog(event, "Snapshot", log); err != nil {
		return nil, err
	}
...
// TokenUnmintableIterator is returned from FilterUnmintable and is used to iterate over the raw logs and unpacked data for Unmintable events raised by the Token contract.
type TokenUnmintableIterator struct {
	Event *TokenUnmintable // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenUnmintableIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenUnmintableIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenUnmintableIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenUnmintable represents a Unmintable event raised by the Token contract.
type TokenUnmintable struct {
	Account common.Address
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Token *TokenFilterer) FilterUnmintable(opts *bind.FilterOpts) (*TokenUnmintableIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "Unmintable")
	if err != nil {
		return nil, err
	}
	return &TokenUnmintableIterator{contract: _Token.contract, event: "Unmintable", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Unmintable(address account)
func (_Token *TokenFilterer) WatchUnmintable(opts *bind.WatchOpts, sink chan<- *TokenUnmintable) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "Unmintable")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenUnmintable)
				if err := _Token.contract.UnpackLog(event, "Unmintable", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Unmintable(address account)
func (_Token *TokenFilterer) ParseUnmintable(log types.Log) (*TokenUnmintable, error) {
	event := new(TokenUnmintable)
	if err := _Token.contract.UnpackLog(event, "Unmintable", log); err != nil {
		return nil, err
	}
